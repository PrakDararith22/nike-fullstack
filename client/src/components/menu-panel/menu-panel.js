        ...
        <div class="menu-panel-content bg-white h-full  py-4 px-8 flex flex-col justify-between">    
            <div class="flex flex-col w-full">
                ...
                <div class="pt-10 flex flex-col gap-4 text-h3 font-semibold">
                    <a href="new-and-featured">New & Featured</a>
                    <a href="Men">Men</a>
            ...
            <div>
                ...
                <div class=" pb-12 mb-12  flex gap-2">
                    ...
                    <base-button text="Sign In" variant="secondary" to="/signin"></base-button>
                </div>

                <div class="flex flex-col gap-3">
                    <icon-button icon="${heart}" text="Favorite" to="/favorite"></icon-button>
                    <icon-button icon="${cartEmpty}" text="Bag" to="/cart"></icon-button>
